...
enum class Cursor {
  ...
  ///< TODO: upgrade glfw to 3.4 to use the diagonal resize cursor.
 ...
 */
extern NANOGUI_EXPORT std::vector<std::string> file_dialog(const std::vector<std::pair<std::string, std::string>>& filetypes,
